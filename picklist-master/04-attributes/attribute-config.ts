/**
 * Attribute Configuration and Fallbacks
 * 
 * SOURCE: Extracted from src/config/constants.ts
 * DEPENDENCY: attributes.json picklist
 * 
 * PURPOSE: Provide fallback attributes when AI schema is incomplete
 * WHEN TO UPDATE: When new attributes are added to attributes.json, add them to relevant categories here
 */
