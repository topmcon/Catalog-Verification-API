...
exports.CATEGORY_SCHEMAS = exports.CEILING_FAN_SCHEMA = exports.PENDANT_SCHEMA = exports.CHANDELIER_SCHEMA = exports.BATHTUB_SCHEMA = exports.TOILET_SCHEMA = exports.BATHROOM_FAUCET_SCHEMA = exports.KITCHEN_FAUCET_SCHEMA = exports.KITCHEN_SINK_SCHEMA = exports.FREEZER_SCHEMA = exports.DRYER_SCHEMA = exports.WASHER_SCHEMA = exports.RANGE_HOOD_SCHEMA = exports.MICROWAVE_SCHEMA = exports.COOKTOP_SCHEMA = exports.OVEN_SCHEMA = exports.RANGE_SCHEMA = exports.DISHWASHER_SCHEMA = exports.REFRIGERATOR_SCHEMA = void 0;
exports.getCategorySchema = getCategorySchema;
exports.getRequiredAttributes = getRequiredAttributes;
/**
 * APPLIANCES DEPARTMENT
 */
exports.REFRIGERATOR_SCHEMA = {
...
exports.BATHROOM_FAUCET_SCHEMA = {
 ...
 */
exports.CATEGORY_SCHEMAS = {
    // Appliances
    'Refrigerator': exports.REFRIGERATOR_SCHEMA,
    'Dishwasher': exports.DISHWASHER_SCHEMA,
    'Range': exports.RANGE_SCHEMA,
    'Oven': exports.OVEN_SCHEMA,
    'Cooktop': exports.COOKTOP_SCHEMA,
    'Microwave': exports.MICROWAVE_SCHEMA,
    'Range Hood': exports.RANGE_HOOD_SCHEMA,
    'Washer': exports.WASHER_SCHEMA,
    'Dryer': exports.DRYER_SCHEMA,
    'Freezer': exports.FREEZER_SCHEMA,
    // Plumbing & Bath
    'Kitchen Sinks #': exports.KITCHEN_SINK_SCHEMA,
    'Kitchen Faucets #': exports.KITCHEN_FAUCET_SCHEMA,
    'Bathroom Faucets #': exports.BATHROOM_FAUCET_SCHEMA,
    'Toilets #': exports.TOILET_SCHEMA,
    'Bathtubs #': exports.BATHTUB_SCHEMA,
    // Lighting
    'Chandeliers #': exports.CHANDELIER_SCHEMA,
    'Pendants #': exports.PENDANT_SCHEMA,
    'Ceiling Fans #': exports.CEILING_FAN_SCHEMA,
};
// Import additional schemas from separate files
const plumbing_schemas_1 = require("./schemas/plumbing-schemas");
const lighting_schemas_1 = require("./schemas/lighting-schemas");
const additional_appliance_schemas_1 = require("./schemas/additional-appliance-schemas");
const home_decor_hvac_schemas_1 = require("./schemas/home-decor-hvac-schemas");
// Merge all schemas
Object.assign(exports.CATEGORY_SCHEMAS, plumbing_schemas_1.PLUMBING_SCHEMAS);
Object.assign(exports.CATEGORY_SCHEMAS, lighting_schemas_1.LIGHTING_SCHEMAS);
Object.assign(exports.CATEGORY_SCHEMAS, additional_appliance_schemas_1.ADDITIONAL_APPLIANCE_SCHEMAS);
Object.assign(exports.CATEGORY_SCHEMAS, home_decor_hvac_schemas_1.HOME_DECOR_HVAC_SCHEMAS);
/**
 * Get category schema by name
 */
function getCategorySchema(categoryName) {
    // Direct match
    if (exports.CATEGORY_SCHEMAS[categoryName]) {
        return exports.CATEGORY_SCHEMAS[categoryName];
    }
    // Try without # suffix
    const withoutHash = categoryName.replace(/ #$/, '');
    if (exports.CATEGORY_SCHEMAS[withoutHash]) {
        return exports.CATEGORY_SCHEMAS[withoutHash];
    }
    // Try with # suffix
    const withHash = categoryName + ' #';
    if (exports.CATEGORY_SCHEMAS[withHash]) {
        return exports.CATEGORY_SCHEMAS[withHash];
    }
    // Case-insensitive search
    const lowerName = categoryName.toLowerCase();
    for (const [key, schema] of Object.entries(exports.CATEGORY_SCHEMAS)) {
 ...
 */
function getRequiredAttributes(categoryName) {
...
exports.default = {
    CATEGORY_SCHEMAS: exports.CATEGORY_SCHEMAS,
    getCategorySchema,
