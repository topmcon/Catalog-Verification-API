...
exports.MASTER_CATEGORIES = exports.ICE_MAKER_SCHEMA = exports.WINE_COOLER_SCHEMA = exports.FREEZER_SCHEMA = exports.DRYER_SCHEMA = exports.WASHER_SCHEMA = exports.RANGE_HOOD_SCHEMA = exports.MICROWAVE_SCHEMA = exports.COOKTOP_SCHEMA = exports.WALL_OVEN_SCHEMA = exports.DISHWASHER_SCHEMA = exports.REFRIGERATOR_SCHEMA = exports.RANGE_SCHEMA = exports.PRIMARY_ATTRIBUTE_DEFINITIONS = exports.PRIMARY_ATTRIBUTES = void 0;
...
exports.getPrimaryAttributesForPrompt = getPrimaryAttributesForPrompt;
exports.getCategoryListForPrompt = getCategoryListForPrompt;
exports.getTop15AttributesForPrompt = getTop15AttributesForPrompt;
exports.getAllCategoriesWithTop15ForPrompt = getAllCategoriesWithTop15ForPrompt;
/**
 * ============================================
...
exports.PRIMARY_ATTRIBUTE_DEFINITIONS = [
...
exports.MASTER_CATEGORIES = {
    ...
    'wall_oven': exports.WALL_OVEN_SCHEMA,
    'oven': exports.WALL_OVEN_SCHEMA,
    'cooktop': exports.COOKTOP_SCHEMA,
    'microwave': exports.MICROWAVE_SCHEMA,
    'range_hood': exports.RANGE_HOOD_SCHEMA,
    'washer': exports.WASHER_SCHEMA,
    'dryer': exports.DRYER_SCHEMA,
    'freezer': exports.FREEZER_SCHEMA,
    'wine_cooler': exports.WINE_COOLER_SCHEMA,
    'ice_maker': exports.ICE_MAKER_SCHEMA
};
/**
 * ============================================
 * UTILITY FUNCTIONS
...
function getAllCategoryNames() {
    return Object.values(exports.MASTER_CATEGORIES).map(c => c.categoryName);
}
/**
 * Get all category IDs
 */
function getAllCategoryIds() {
    return Object.keys(exports.MASTER_CATEGORIES);
}
/**
 * Get category schema by ID or name
 */
function getCategorySchema(categoryIdOrName) {
    const normalized = categoryIdOrName.toLowerCase().replace(/[^a-z0-9]/g, '_');
    // Direct match by ID
    if (exports.MASTER_CATEGORIES[normalized]) {
        return exports.MASTER_CATEGORIES[normalized];
    }
    // Search by name or alias
    for (const schema of Object.values(exports.MASTER_CATEGORIES)) {
 ...
 */
function getPrimaryAttributesForPrompt() {
    return exports.PRIMARY_ATTRIBUTES.map((attr, idx) => `${idx + 1}. ${attr}`).join('\n');
}
/**
 ...
 */
function getTop15AttributesForPrompt(categoryId) {
 ...
 */
function getAllCategoriesWithTop15ForPrompt() {
    const uniqueCategories = new Map();
    for (const schema of Object.values(exports.MASTER_CATEGORIES)) {
        uniqueCategories.set(schema.categoryId, schema);
    }
...
//# sourceMappingURL=master-category-attributes.js.map