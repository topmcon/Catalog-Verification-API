 ...
 */
function matchCategory(productData) {
 ...
 */
function findDirectMatch(input) {
    ...
    for (const [dept, categories] of Object.entries(DEPARTMENT_CATEGORIES)) {
        for (const cat of categories) {
            ...
            // Check aliases
            const aliases = category_schema_1.CATEGORY_ALIASES[cleanCat] || [];
...
exports.default = { matchCategory, getAllCategories };
//# sourceMappingURL=category-matcher.service.js.map