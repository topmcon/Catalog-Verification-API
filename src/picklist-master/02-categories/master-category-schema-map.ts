...
import { CategoryAttributeConfig } from '../06-attributes/category-attributes';
...
import {
  ...
  PENDANT_SCHEMA,
  CEILING_FAN_SCHEMA,
} from '../06-attributes/category-attributes';
...
} from '../06-attributes/schemas/plumbing-schemas';
...
} from '../06-attributes/schemas/lighting-schemas';
...
} from '../06-attributes/schemas/additional-appliance-schemas';
...
import {
  ...
  WATER_FILTER_SCHEMA,
} from '../06-attributes/schemas/complete-category-schemas';
...
import {
  ...
  DRAWER_SCHEMA,
  PEDESTAL_SCHEMA,
} from '../06-attributes/schemas/home-decor-hvac-schemas';
