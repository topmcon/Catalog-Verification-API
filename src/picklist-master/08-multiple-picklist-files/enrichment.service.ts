...
import { getRequiredAttributes, CategoryAttributeConfig } from '../04-attributes/category-attributes';
import { getSchemaForCategory } from '../02-categories/master-category-schema-map';
