...
const TYPE_ALIASES: Record<string, Record<string, string>> = {
  ...
  'vessel filler': { 'Bathroom Faucet': 'Vessel' },
  ...
  'shower system': { 'Showerheads & Accessories': 'System', 'Shower': 'System' },
  'shower tower': { 'Showerheads & Accessories': 'System', 'Shower': 'System' },
  'rain shower': { 'Showerheads & Accessories': 'Rain Head' },
  'rain head': { 'Showerheads & Accessories': 'Rain Head' },
  'body spray': { 'Showerheads & Accessories': 'Body Spray' },
  'bodyspray': { 'Showerheads & Accessories': 'Body Spray' },
  'hand shower': { 'Showerheads & Accessories': 'Handheld' },
  'handshower': { 'Showerheads & Accessories': 'Handheld' },
  'showerhead': { 'Showerheads & Accessories': 'Single Function' },
  'shower head': { 'Showerheads & Accessories': 'Single Function' },
  'single function': { 'Showerheads & Accessories': 'Single Function' },
  'volume control': { 'Showerheads & Accessories': 'Volume Control' },
  'diverter': { 'Showerheads & Accessories': 'Diverter', 'Shower Accessory': 'Diverter' },
  'trim only': { 'Showerheads & Accessories': 'Trim Only' },
  'exposed shower': { 'Showerheads & Accessories': 'Exposed' },
  'waterfall shower': { 'Showerheads & Accessories': 'Waterfall' },
  'waterfall showerhead': { 'Showerheads & Accessories': 'Waterfall' },
  'shower arm': { 'Shower Accessory': 'Shower Arm' },
  'ceiling arm': { 'Shower Accessory': 'Ceiling Mount' },
  'ceiling shower arm': { 'Shower Accessory': 'Ceiling Mount' },
  'ceiling mount shower': { 'Shower Accessory': 'Ceiling Mount' },
  'slide bar': { 'Shower Accessory': 'Slide Bar' },
  'slidebar': { 'Shower Accessory': 'Slide Bar' },
  'escutcheon': { 'Shower Accessory': 'Escutcheon' },
  'door handle': { 'Shower Accessory': 'Escutcheon' },
  'door pull': { 'Shower Accessory': 'Escutcheon' },
  'shower door handle': { 'Shower Accessory': 'Escutcheon' },
  'shower hose': { 'Shower Accessory': 'Hose' },
  'valve extension': { 'Shower Accessory': 'Valve Extension' },
  'extension kit': { 'Shower Accessory': 'Valve Extension' },
  'transfer handle': { 'Shower Accessory': 'Transfer' },
  'transfer valve': { 'Shower Accessory': 'Transfer' },
  'supply elbow': { 'Shower Accessory': 'Elbow' },
  'wall elbow': { 'Shower Accessory': 'Elbow' },
  'shower shelf': { 'Shower Accessory': 'Shelf' },
  'grab bar': { 'Shower Accessory': 'Grab Bar', 'Bathroom Hardware and Accessories': 'Grab Bar' },
  'linear drain': { 'Shower Accessory': 'Linear' },
  'trench drain': { 'Shower Accessory': 'Linear' },
  'shower drain': { 'Shower Accessory': 'Linear' },
  'floor drain': { 'Shower Accessory': 'Floor Drain' },
  'shower niche': { 'Shower Accessory': 'Niche' },
  'shower seat': { 'Shower Accessory': 'Seat' },
  'shower bench': { 'Shower Accessory': 'Seat' },
  'riser': { 'Shower Accessory': 'Riser' },
  'shower riser': { 'Shower Accessory': 'Riser' },
  
  // ============================================
  // PLUMBING ALIASES - Sinks & Bathtubs
  // ============================================
  'freestanding tub': { 'Bathtub': 'Freestanding' },
  'freestanding bathtub': { 'Bathtub': 'Freestanding' },
  'alcove': { 'Bathtub': 'Alcove' },
  'alcove tub': { 'Bathtub': 'Alcove' },
  'alcove bathtub': { 'Bathtub': 'Alcove' },
  'drop-in': { 'Bathtub': 'Drop-In', 'Kitchen Sink': 'Drop-In' },
  'drop in': { 'Bathtub': 'Drop-In', 'Kitchen Sink': 'Drop-In' },
  'drop-in tub': { 'Bathtub': 'Drop-In' },
  'drop-in sink': { 'Kitchen Sink': 'Drop-In', 'Bathroom Sink': 'Drop-In' },
  'topmount': { 'Kitchen Sink': 'Drop-In', 'Bathroom Sink': 'Drop-In' },
  'undermount': { 'Kitchen Sink': 'Undermount', 'Bathroom Sink': 'Undermount', 'Bathtub': 'Undermount' },
  'undermount tub': { 'Bathtub': 'Undermount' },
  'undermount sink': { 'Kitchen Sink': 'Undermount', 'Bathroom Sink': 'Undermount' },
  'under mount': { 'Kitchen Sink': 'Undermount', 'Bathroom Sink': 'Undermount', 'Bathtub': 'Undermount' },
  'clawfoot': { 'Bathtub': 'Clawfoot' },
  'clawfoot tub': { 'Bathtub': 'Clawfoot' },
  'claw foot': { 'Bathtub': 'Clawfoot' },
  'corner tub': { 'Bathtub': 'Corner' },
  'corner bathtub': { 'Bathtub': 'Corner' },
  'walk-in tub': { 'Bathtub': 'Walk-In' },
  'walk in tub': { 'Bathtub': 'Walk-In' },
  'walk-in bathtub': { 'Bathtub': 'Walk-In' },
  ...
  'safety bar': { 'Bathroom Hardware and Accessories': 'Grab Bar', 'Shower Accessory': 'Grab Bar' },
