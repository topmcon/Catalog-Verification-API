...
const PRIMARY_ATTRIBUTE_FIELD_KEYS = new Set([
  'ai_brand', 'brand_verified', 'brand',
  'ai_product_category', 'category_subcategory_verified', 'category_subcategory', 'category',
  'ai_product_family', 'product_family_verified', 'product_family',
  'ai_style', 'product_style_verified', 'product_style', 'style',
  'ai_depth', 'depth_length_verified', 'depth_length', 'depth', 'length',
  'ai_width', 'width_verified', 'width',
  'ai_height', 'height_verified', 'height',
  'ai_weight', 'weight_verified', 'weight',
  'ai_msrp', 'msrp_verified', 'msrp',
  'market_value',
  'ai_description', 'description',
  'ai_product_title', 'product_title_verified', 'product_title', 'title',
  'ai_features', 'features_list', 'features',
  'ai_upc_gtin', 'upc_gtin_verified', 'upc_gtin', 'upc', 'gtin',
  'ai_model_number', 'model_number_verified', 'model_number',
  'ai_model_alias', 'model_number_alias',
  'ai_model_parent', 'model_parent',
  'ai_model_variant_number', 'model_variant_number', 'model_variant',
  'ai_total_model_variants', 'total_model_variants',
]);
