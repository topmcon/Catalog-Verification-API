...
export class VerificationAnalyticsService {
  ...
  // NOTE: _parseDocumentsAnalyzed and mapDocumentsToSchema methods removed
  // documents_analyzed tracking is disabled due to schema mismatch errors
  // These methods were causing TS compilation errors since they're unused
}
