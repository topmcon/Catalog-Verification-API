 ...
 * Single source of truth for brand lists, category aliases, and feature keywords.
 * 
 ...
 * - Category aliases → ./category-aliases.ts (CATEGORY_ALIASES source of truth)
 * - AI category aliases → This file (AI_CATEGORY_ALIASES, regenerated by scripts)
 * 
...
export const AI_CATEGORY_ALIASES: Record<string, string> = {
  ...
  'freestanding bathtub': 'bathtub',
  'alcove bathtub': 'bathtub',
  'soaking tub': 'bathtub',
  'whirlpool tub': 'bathtub',
  ...
  'one piece toilet': 'toilet',
  'two piece toilet': 'toilet',
  'comfort height toilet': 'toilet',
  'bidet toilet': 'toilet',
};
