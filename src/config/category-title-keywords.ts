...
export const NON_APPLIANCE_CATEGORY_TITLE_KEYWORDS: Record<string, string[]> = {
  ...
  'Bathroom Faucet': ['bathroom faucet', 'lavatory faucet', 'widespread faucet', 'centerset faucet', 'bath faucet', 'lav faucet'],
  ...
  'Showerheads & Accessories': ['shower faucet', 'shower trim', 'shower valve', 'shower system', 'shower head', 'showerhead', 'rain shower', 'hand shower', 'shower combo', 'shower accessory'],
