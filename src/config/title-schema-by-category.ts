...
export const CATEGORY_TITLE_SCHEMAS: Record<string, CategoryTitleSchema> = {
  ...
  "cooktop": {
    ...
    "seoNotes": "Width + Fuel Type essential. Installation = Built-In, Drop-In."
  },
  "dishwasher": {
    ...
    "seoNotes": "Width (only if 18\"). dBA is top qualifier. Type = Built-In, Portable, Drawer."
  },
  "drawer": {
  ...
  "range_hood": {
    ...
    "seoNotes": "Width matches range. CFM is key spec. Type = Under-Cabinet, Wall Mount, Island, Insert."
  },
  "refrigerator": {
